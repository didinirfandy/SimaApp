...
(function () {
	...
	function fb(k) {
		if (k._menuButton) k.exportEnabled ?
			Ka(k._menuButton) : ua(k._menuButton);
	...
	w = Oa.Chart = function () {
		...
		l.prototype.categoriseDataSeries = function () {
			for (var a = "", d = 0; d < this.data.length; d++)
				if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
					for (var c =
							null, b = !1, e = null, f = !1, n = 0; n < this.plotInfo.plotTypes.length; n++)
				...
				for (c = this.plotInfo.plotTypes[d], n = a = 0; n < c.plotUnits.length; n++) c.plotUnits[n].previousDataSeriesCount = a, a += c.plotUnits[n].dataSeriesIndexes.length
		};
						...
						for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, g = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
							...
							if (!(4 > k.dataPoints.length))
								for (q = 0; q < k.dataPoints.length; q++)
									if (b && (p = (n + 1 - g) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() :
										...
										if ((h = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && h.length)
											for (var t = 0; t < h.length; t++) p = Math.floor((h[t] - m) / l), h[t] < d[p].min && (d[p].min = h[t]), h[t] > d[p].max && (d[p].max = h[t]);
				...
				if (a.dataSeriesIndexes &&
					...
					for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, h, g = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
						...
						if (!(4 > m.dataPoints.length))
							for (g = 0; g < m.dataPoints.length; g++) h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[g].x.getTime ? m.dataPoints[g].x.getTime() : m.dataPoints[g].x, h = Math.floor((b -
					...
					if (this._axes[n].dataInfo._dataRanges) {
						...
						if (this._axes[n].scaleBreaks.customBreaks)
							for (m = 0; m < this._axes[n].scaleBreaks.customBreaks.length; m++)
								for (b =
									0; b < f.length; b++)
									if (this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].startValue && this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].end || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue && this._axes[n].scaleBreaks.customBreaks[m].endValue <=
		...
		l.prototype._plotAreaMouseUp = function (a, d) {
			...
			if ("none" !== this.plotInfo.axisPlacement) {
				...
				if (this.axisY &&
					0 < this.axisY.length)
					for (n = 0; n < this.axisY.length; n++) this.axisY[n].crosshair && this.axisY[n].crosshair.enabled && this.axisY[n].renderCrosshair(a, d);
		...
		l.prototype.validateRegion = function (a, d, c, b, e) {
			...
			for (n = 0; n < g.length; n++) {
				...
				if (p > h) var C = h,
					...
					p = C;
				if (q.scaleBreaks)
					for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++) f = q.scaleBreaks._appliedBreaks[C].startValue <= p && q.scaleBreaks._appliedBreaks[C].endValue >= h;
		...
		l.prototype.renderIndexLabels = function (a) {
			...
			for (a = 0; a < this._indexLabels.length; a++) {
				var g = this._indexLabels[a],
					...
					q, p, m = ma("indexLabelFontColor", g.dataPoint,
						g.dataSeries),
					...
					if (0 < r.length) {
						for (var J = !1, u = 0; u < r.length; u++)
							if (x = r[u].getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J)))
								if ("number" !== typeof r[u].y) 0 < u && !(g.connectNullData || J || l) && (c.stroke(),
									t && b.stroke()), J = !0;
								else {
									var y = s;
									x = a.axisX.convertValueToPixel(x);
			...
			function d(a) {
				...
				if (0 < a.length) {
					...
					for (var c = 0; c < a.length - 3; c += 3)
						if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), t && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
				...
				for (var n = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
					...
					if (0 < r.length)
						for (s = !1, l = 0; l < r.length; l++)
							if (u = r[l].getTime ? r[l].x.getTime() : r[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !s)))
				...
				for (r = 0; r < a.dataSeriesIndexes.length; r++) {
					...
					if (0 < C.length)
						for (var k = 5 < q && h.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++)
							if (C[f].getTime ? A = C[f].x.getTime() :
						...
						for (g = 0; g < u.length; g++)
							if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
								...
								if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) m[b] = u[g].y + (m[b] ? m[b] : 0), 0 < m[b] && (q = a.axisY.convertValueToPixel(m[b]),
									y = "undefined" !== typeof f[b] ? f[b] : p, f[b] = q);
								else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = u[g].y + (A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = "undefined" !== typeof n[b] ? n[b] : p, n[b] = y;
						...
						for (var s = 5 < h && l.bevelEnabled ? !0 : !1, g = 0; g < u.length; g++)
							if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
								...
								if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
									...
									y = f[b] ? f[b] : p;
									f[b] = q
								} else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = q + ("undefined" !== typeof A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = n[b] ? n[b] : p, n[b] = y;
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
					...
					if (0 < u.length) {
						...
						c.strokeStyle = "#4572A7 ";
						for (g = 0; g < u.length; g++)
							if (b = u[g].x.getTime ? u[g].x.getTime() :
								...
								var z = q - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
									J = z + h << 0,
									y;
								if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) m[b] = u[g].y + (m[b] ? m[b] : 0), 0 < m[b] && (y = f[b] ? f[b] : p, f[b] = r = a.axisY.convertValueToPixel(m[b]));
								else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = u[g].y + (A[b] ? A[b] : 0), r = n[b] ?
									n[b] : p, n[b] = y = a.axisY.convertValueToPixel(A[b]);
						...
						for (g = 0; g < u.length; g++)
							if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
								...
								if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
									...
									p, n[b] = z = a.axisY.convertValueToPixel(A[b]);
				...
				for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
					...
					if (0 < C.length) {
						...
						for (var ha = !0; k < C.length; k++)
							if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin ||
									s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ha)))
		...
		l.prototype.renderSplineArea = function (a) {
				...
				if (0 < c.length) {
					if (0 < r.lineThickness) {
						...
						for (var d = 0; d < c.length - 3; d += 3)
							if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), t && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(),
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
					...
					var n = [],
						p = 0,
						h, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
						l, u = null,
						s = [];
					if (0 < q.length) {
						...
						for (C = !1; p < q.length; p++)
							if (h = q[p].x.getTime ? q[p].x.getTime() : q[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C)))
								if ("number" !== typeof q[p].y) 0 < p && !C && (r.connectNullData ? b.setLineDash && (0 < s.length && (r.options.nullDataLineDashType || !q[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = w,
									B = r.nullDataLineDashType) : (d(), s = [])), C = !0;
								else {
		...
		l.prototype.renderStepArea = function (a) {
			...
			function b() {
				y && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = z : 0 > a.axisY.viewportMaximum ? J = m.y1 : 0 < a.axisY.viewportMinimum && (J = z), f.lineTo(l, J), f.lineTo(y.x, J), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, t && (n.lineTo(l, J), n.lineTo(y.x, J), n.closePath(), n.fill()),
					f.beginPath(), f.moveTo(l, u), n.beginPath(), n.moveTo(l, u), y = {
						x: l,
						y: u
					})
			}
				...
				for (v = 0; v < a.dataSeriesIndexes.length; v++) {
					...
					if (0 < r.length) {
						...
						for (var Z = !0, p = 0; p < r.length; p++) {
							...
							if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z)))
								if ("number" !== typeof ia.y) B.connectNullData || (Z || aa) || d(), Z = !0;
								else {
									var na;
		...
		l.prototype.renderBubble = function (a) {
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (var m = -Infinity, k = Infinity, g = 0; g < a.dataSeriesIndexes.length; g++)
					for (var r = a.dataSeriesIndexes[g], q = this.data[r], p = q.dataPoints, h = 0, e = 0; e < p.length; e++) f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ||
				...
				for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
					...
					if (0 < r.length) {
						...
						for (var q = 0, p = 0, e = 0; e < r.length; e++)
							if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
					...
					for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
						...
						if (0 < x.length)
							for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++)
								if (x[m].getTime ? h = x[m].x.getTime() : h = x[m].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] && "number" === typeof x[m].y[1] && "number" === typeof x[m].y[2] && "number" === typeof x[m].y[3]) {
				...
				for (var ga = !1, ga = !!a.axisY.reversed, aa = 0; aa < a.dataSeriesIndexes.length; aa++) {
					...
					if (0 < z.length)
						for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++)
							if (z[n].getTime ? h = z[n].x.getTime() : h = z[n].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) &&
		...
		l.prototype.renderRangeColumn = function (a) {
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				var b = null,
					e = this.plotArea,
					f = 0,
					n, m, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
				...
				for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
					...
					if (0 < h.length)
						for (var l = 5 < g && p.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++)
							if (h[f].getTime ? k = h[f].x.getTime() : k = h[f].x, !(k < a.axisX.dataInfo.viewPortMin ||
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
					var z = a.dataSeriesIndexes[x],
						...
						D = 0;
					if (B)
						for (e = v._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) &&
				...
				for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
					...
					if (0 < q.length) {
						...
						for (var L = !0; h < q.length; h++)
							if (u = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax &&
									(!r.connectNullData || !L)))
				...
				for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
					...
					if (0 < r.length) {
						...
						for (h = !1; q < r.length; q++)
							if (p = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!g.connectNullData ||
									!h)))
		...
		l.prototype.renderWaterfall = function (a) {
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				var b = this._eventManager.ghostCtx,
					...
					f = this.plotArea,
					n = 0,
					m, k, g, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
		...
		l.prototype.renderPie = function (a) {
				...
				if (0 <= a && a < r.length) {
					...
					for (n = 1; n < r.length; n++)
						if (m = (a - n + h.length) % h.length, h[m].hemisphere !== h[a].hemisphere) {
							...
							h[a].indexLabelTextBlock.y : h[m].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))) break;
					else m = null;
					q = m;
					p = e(a);
					n = m = 0;
			...
			function n() {
				...
				for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
					...
					for (a = 0; a < r.length; a++)
						if (n = h[a], y = n.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === n.hemisphere ? (y = p.x2 - (n.indexLabelTextBlock.x + n.indexLabelTextBlock.width + q), y *= -1) : y = p.x1 - (n.indexLabelTextBlock.x - n.indexLabelTextBlock.width - q), 0 < y && (!m && n.indexLabelText &&
		...
		l.prototype.renderFunnel = function (a) {
			...
			function e() {
				...
				if (e)
					for (m = H.length - 1; 0 <= m; m--) a = Q[m], H[m].textBlock.maxWidth = f[f.length - (m + 1)], H[m].textBlock.measureText(), H[m].textBlock.x = M - g, c = H[m].textBlock.height <
			...
			function f() {
				...
				if ("inside" !== u.indexLabelPlacement)
					for (var e = 0; e < Q.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? h(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? h(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > T + D && (H[e].textBlock.y = T + D - H[e].height),
						H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D)) : (H[e].textBlock.y < T - D && (H[e].textBlock.y = T - D), H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
				else
					for (e = 0; e < Q.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != da ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0)
			}
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, G = Math.min(z.width - 2 * y, 2.8 * z.height), L = !1, O = 0; O < x.length; O++)
					if (!L && ("undefined" !== typeof x[O].indexLabel && null !== x[O].indexLabel && 0 < x[O].indexLabel.toString().length) && (L = !0), !L && ("undefined" !== typeof x[O].label && null !== x[O].label &&
