    ...
    <div class="sidebar-collapse">
        ...
        if ($role == 1) { ?>
            ...
            <ul class="nav" id="main-menu">
                ...
                <li class="<?php if ($this->uri->segment(1) == "Master_data") {
                                echo "active";
                            } ?>">
                    <a href="#" class="<?php if ($this->uri->segment(1) == "Master_data") {
                                            echo "active";
                                        } ?>"><i class="fa fa-laptop"></i> Data Master<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "data_usulan_pengadaan") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Master_data/data_usulan_pengadaan'); ?>"><i class="fa fa-long-arrow-right"></i> Data Usulan Pengadaan</a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "data_pengadaan") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Master_data/data_pengadaan'); ?>"><i class="fa fa-long-arrow-right"></i> Data Pengadaan</a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "data_peminjaman") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Master_data/data_peminjaman'); ?>"><i class="fa fa-long-arrow-right"></i> Data Peminjaman</a>
                        </li>
                    </ul>
                </li>
                <li class="<?php if ($this->uri->segment(1) == "Kib") {
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "kib_e") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Kib/kib_e'); ?>"><i class="fa fa-long-arrow-right"></i> KIB E</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li class="<?php if ($this->uri->segment(1) == "Lp_kib") {
                    ...
                    <ul class="nav nav-second-level">
                        <li class="<?php if ($this->uri->segment(1) == "Lp_kib") {
                            ...
                            <a href="#" class="<?php if ($this->uri->segment(1) == "Lp_kib") {
                                                    echo "active";
                                                } ?>"><i class="fa fa-long-arrow-right"></i> KIB<span class="fa arrow"></span></a>
        ...
        <?php } elseif ($role == 2) { ?>
            ...
            <ul class="nav" id="main-menu">
                <li>
                    <a class="<?php if ($this->uri->segment(2) == "home") {
                                    echo "active-menu";
                                } ?>" href="<?= base_url('Wakasek/home') ?>"><i class="fa fa-home"></i> Dashboard</a>
                </li>
                <li class="<?php if ($this->uri->segment(1) == "Kib") {
                                echo "active";
                            } ?>">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "kib_a_wk") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Kib/kib_a_wk'); ?>"><i class="fa fa-long-arrow-right"></i> KIB A</a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "kib_b_wk") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Kib/kib_b_wk'); ?>"><i class="fa fa-long-arrow-right"></i> KIB B</a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "kib_c_wk") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Kib/kib_c_wk'); ?>"><i class="fa fa-long-arrow-right"></i> KIB C</a>
                        </li>
                        <li>
                ...
                <li>
                    <a class="<?php if ($this->uri->segment(2) == "pengadaan_aset_wk") {
                                    echo "active-menu";
                                } ?>" href="<?= base_url('Pengadaan_aset/pengadaan_aset_wk') ?>"><i class="fa fa-shopping-cart"></i> Pengadaan Aset</a>
                </li>
                <li>
        ...
        <?php } elseif ($role == 3) { ?>
            ...
            <ul class="nav" id="main-menu">
                <li>
                    <a class="<?php if ($this->uri->segment(2) == "home") {
                                    echo "active-menu";
                                } ?>" href="<?= base_url('Kepsek/home') ?>"><i class="fa fa-home"></i> Dashboard</a>
                </li>
                <li class="<?php if ($this->uri->segment(1) == "Kib") {
                                echo "active";
                            } ?>">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "kib_a_kep") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Kib/kib_a_kep'); ?>"><i class="fa fa-long-arrow-right"></i> KIB A</a>
                        </li>
                        <li>
                            <a class="<?php if ($this->uri->segment(2) == "kib_b_kep") {
                                            echo "active-menu";
                                        } ?>" href="<?= base_url('Kib/kib_b_kep'); ?>"><i class="fa fa-long-arrow-right"></i> KIB B</a>
                        </li>
                        <li>
                ...
                <li>
                    <a class="<?php if ($this->uri->segment(2) == "pengadaan_aset_kep") {
                                    echo "active-menu";
                                } ?>" href="<?= base_url('Pengadaan_aset/pengadaan_aset_kep') ?>"><i class="fa fa-shopping-cart"></i> Pengadaan Aset</a>
                </li>
                <li>
